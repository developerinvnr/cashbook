...
<body>
<form name="payment" id="payment" method="POST" action="paymentQ.php" onSubmit="return ValidateForm()">		
	...
	<td>
		...
		<tr>
			<td valign="top">
				...
				<select name="locationId" id="locationId" style="width:194px;height:20px;" onchange="get_cash_in_hand(this.value,'P')">
						...
						<tr>
							<td width="770px">
								...
								<tr height="10px" width="770px">
									...
									<td width="230px"><input name="VoucherNo" readonly="true" class="styleInput" style="background-color:#FFE1FF;"></td>
								...
								<tr height="10px" width="770px">
									...
									<?php if($_SESSION['cashbook_utype']=="A" || $_SESSION['cashbook_utype']=="S"){?>
									<td width="230px" id="tdCIH"><input name="cih" id="cih" size="34" readonly="true" value="Cash in hand" style="background-color:#FFE1FF;"><input type="hidden" name="cihName" id="cihName" value="0"/></td>
									<?php } elseif($_SESSION['cashbook_utype']=="U"){?>
									<td width="230px"><input name="cih" id="cih" size="34" readonly="true" value="<?php echo $_SESSION['cashbook_cihname'];?>" style="background-color:#FFE1FF;"><input type="hidden" name="cihName" id="cihName" value="<?php echo $_SESSION['cashbook_cihid'];?>"/></td>
									<?php } ?>
		...
		<?php $sqld=mysql_db_query(DATABASE2,"SELECT * FROM department where DeptStatus='A' ORDER BY DepartmentCode ASC");
			  ...
			  echo '<option value="'.$resd['DepartmentId'].'">'.$resd['DepartmentName'].'</option>';
								...
								<tr height="10px" width="770px">
									...
									<td width="120px"><input name="TotalAmt" id="TotalAmt" value="0" readonly="true" class="styleInput1" style="background-color:#FFE1FF;"></td>
								</tr>
								</table>
							</td>
						</tr>
